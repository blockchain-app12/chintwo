...
import org.tron.common.crypto.jce.ChintwoCastleProvider;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(ChintwoCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = ChintwoCastleProvider.getInstance();
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(ChintwoCastleProvider.getInstance(), privateKeyFromBigInteger(priv), pub);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory.getInstance(ChintwoCastleProvider.getInstance())
